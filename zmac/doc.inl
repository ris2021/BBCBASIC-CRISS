static char *documentation =
	...
	" \n"
	" --dotlocals\n"
	"  Labels that start with _\".\"_ are local between labels (implied by _--zmac_).\n"
	" \n"
	" --filelocals\n"
	"  Labels that start with _\"__\"_ are local for the file (implied by _--zmac_).\n"
	" \n"
	" --z180\n"
	...
	"\n"
	"A \"_._\" may optionally preceed any psuedo-op.\n"
	...
	"of _exx_ and _ex_.\n"
	"\n"
	"Multiple statements per line are separated by _\\_.  For example:\n"
	"\n"
	"_  ld  d,h_\n"
	"\n"
	"_  ld  e,l_\n"
	...
	" _endif_\n"
	"\n"
	"_%%_ appearing inside a macro will expand to the number of parameters\n"
	"passed to the macro.\n"
	"\n"
